...
for i in range(3,21): # 3 to 21 minutes ahead --- change this to test!!!
    ...
    for x in range(len(data)):
        ...
        if contact_scid in scid_list:
            ...
            if aos_full_pres.year == now.year and los_full_pres.year == now.year and\
               aos_full_pres.month == 1 and los_full_pres.month == 1 and now.month ==12:
                yr_change = now + timedelta(days=1)
                aos_full_pres = dt(yr_change.year,yr_change.month,yr_change.day,\
                                   aos_full_00.hour,aos_full_00.minute,aos_full_00.second)
                los_full_pres = dt(yr_change.year,yr_change.month,yr_change.day,\
                                   los_full_00.hour,los_full_00.minute,los_full_00.second)
